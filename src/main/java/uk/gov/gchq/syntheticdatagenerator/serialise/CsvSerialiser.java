 ...
 */
/*
public class CsvSerialiser<O> implements Serialiser<O> {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = LoggerFactory.getLogger(CsvSerialiser.class);
    ...
    /*
    @JsonCreator
    public CsvSerialiser(@JsonProperty("domainClass") final Class<O> domainClass) {
        ...
        if (nonNull(objects)) {
            ...
            try {
                ...
                try {
                    ...
                    LOGGER.warn("Unable to flush Csv DataFileWriter", e);
                }
